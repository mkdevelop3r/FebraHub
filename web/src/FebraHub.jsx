...
import { C, GROTESK, SANS, ALTURA_PAINEL, Bloco, ChipKpi, Estado } from "./lib/ui.jsx";

const qc = new QueryClient({
  defaultOptions: { queries: { retry: 1, refetchOnWindowFocus: false } },
});

/* Tokens e primitivos vivem em lib/ui.jsx — precisam ser IMPORTAVEIS.
   Eram privados deste arquivo, e o DESIGN_SYSTEM.md mandava usa-los sem que
   houvesse como: quem escrevia tela em Rotas/ reimplementava de memoria, e a
   copia divergia. Ver o cabecalho de lib/ui.jsx. */
